    ...
    let html = `
    	<div id="footer-main">
            <div class="links">
                ...
                |
                <a class="dark" href="https://github.com/huzhen813/forum">源码地址</a>
            </div>
            <div class="col-fade">
...
let common_init = function () {
    // 置顶
    $('body').append(backTopHtml)
    $(document).on('scroll', scroll_event)
    $(document).on('click', '#back-top', cb_back_top)
    // 页脚
